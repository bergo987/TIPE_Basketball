...
while True:
    ...
    cap = cv2.VideoCapture('/Users/hugo/Documents/Cours/Prepa/TIPE/TIPE_Baskettball/archive/extrait_coupe_france.mov')
    ...
    while True:
        ...
        c_line_bis = (255,0,140)

        cv2.line(img=frame, pt1=(0,4*qart_h), pt2=(1919,4*qart_h),color=c_line_bis, thickness= tick_line)
